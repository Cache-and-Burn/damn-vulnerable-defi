...
describe('[Challenge] Puppet v2', function () {
    ...
    it('Exploit', async function () {
        ...
        this.hack = await (await ethers.getContractFactory('PuppetV2Attack', attacker)).deploy(
        ...
        //approve attack contract for token transfer
        this.token.connect(attacker).approve(this.hack.address, POOL_INITIAL_TOKEN_BALANCE);

        //attack
        this.hack.attack( {value: ethers.utils.parseEther('19.8')} );
